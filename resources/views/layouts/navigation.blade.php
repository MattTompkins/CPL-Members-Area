    ...
    <nav class="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
        ...
        <div class="hidden lg:flex lg:gap-x-12">
            ...
            <div class="relative">
                <button type="button" class="flex items-center gap-x-1 text-sm font-semibold leading-6 text-gray-100"
                    aria-expanded="false" id="dropdownNavbarLink" data-dropdown-toggle="dropdownMenuExec">
                    {{ __('Exec') }}
                ...
                <div class="absolute -left-8 top-full z-10 mt-3 w-screen max-w-md overflow-hidden rounded-3xl shadow-lg ring-1 ring-gray-900/5 bg-gray-900 shadow-2xl hidden"
                    ...
                    <div class="p-4">
                        ...
                        <div
                            ...
                            <div class="flex-auto">
                                <a href="{{ route('contacts.index') }}" class="block font-semibold text-gray-100">
                                    {{ __('Contacts') }}
                                    <span class="absolute inset-0"></span>
                                </a>
                                <p class="mt-1 text-gray-200">
                                    {{ __('Useful contacts for suppliers, clients or partner organisations.') }}</p>
                            </div>
                        </div>
                ...
                <div class="absolute -left-8 top-full z-10 mt-3 w-screen max-w-md overflow-hidden rounded-3xl shadow-lg ring-1 ring-gray-900/5 bg-gray-900 shadow-2xl hidden"
                    ...
                    <div class="p-4">
                        ...
                        <div
                            ...
                            <div class="flex-auto">
                                <a href="{{ route('events.index') }}" class="block font-semibold text-gray-100">
                                    {{ __('Events list') }}
                                    <span class="absolute inset-0"></span>
                                </a>
                                <p class="mt-1 text-gray-200">
                                    {{ __('View a list of upcoming events to sign up for.') }}</p>
                            </div>
                        </div>
                        {{-- Single dropdown item end --}}
                        ...
                        <div
                            ...
                            <div class="flex-auto">
                                <a href="{{ route('events.manage') }}" class="block font-semibold text-gray-100">
                                    {{ __('Manage events') }}
                                    <span class="absolute inset-0"></span>
                                </a>
                                <p class="mt-1 text-gray-200">
                                    {{ __('View a list of current and past events to edit or delete.') }}</p>
                            </div>
                        </div>
                        {{-- Single dropdown item end --}}
                        ...
                        <div
                            ...
                            <div class="flex-auto">
                                <a href="{{ route('events.create') }}" class="block font-semibold text-gray-100">
                                    {{ __('Create event') }}
                                    <span class="absolute inset-0"></span>
                                </a>
                                <p class="mt-1 text-gray-200">
                                    {{ __('Create a new upcoming event for members and/or the public to sign up to.') }}
                                </p>
                            </div>
                        </div>
                        {{-- Single dropdown item end --}}
                        ...
                        <div
                            ...
                            <div class="flex-auto">
                                ...
                                <p class="mt-1 text-gray-200">
                                    {{ __('View, approve and reject signups for various events.') }}</p>
                            </div>
                        </div>
                        {{-- Single dropdown item end --}}
                ...
                <div class="absolute -left-8 top-full z-10 mt-3 w-screen max-w-md overflow-hidden rounded-3xl shadow-lg ring-1 ring-gray-900/5 bg-gray-900 shadow-2xl hidden"
                    ...
                    <div class="p-4">
                        ...
                        <div
                            ...
                            <div class="flex-auto">
                                <a href="{{ route('members.groups') }}" class="block font-semibold text-gray-100">
                                    {{ __('Manage user groups') }}
                                    <span class="absolute inset-0"></span>
                                </a>
                                <p class="mt-1 text-gray-200">
                                    {{ __('See a list of the users in each group, and their permissions.') }}
                                </p>
                            </div>
                        </div>
                        {{-- Single dropdown item end --}}
        ...
        <div class="hidden lg:flex lg:flex-1 lg:justify-end">
            <x-dropdown align="right" width="48">
                <x-slot name="trigger">
                    <button
                        class="inline-flex items-center border border-transparent text-sm leading-4 font-medium rounded-md text-gray-200 focus:outline-none transition ease-in-out duration-150">
                        <div><img class="h-10 w-10 flex-none rounded-full bg-gray-50"
