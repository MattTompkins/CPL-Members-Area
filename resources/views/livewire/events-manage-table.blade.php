<div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
    ...
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg bg-white dark:bg-gray-800 p-3">
                    ...
                    <tr
                        ...
                        <th scope="row"
                            ...
                            <div class="mt-1 flex items-center gap-x-1.5">
                                ...
                                <p class="text-xs leading-5 text-gray-500 dark:text-gray-300">{{ $event['start_date'] }} @if($event['end_date']) - {{ $event['end_date'] }} @endif</p>
                            </div>
                        </th>
                        <td class="px-6 py-4 hidden sm:flex sm:flex-col sm:items-end">
                            <p class=" leading-6 text-gray-900 dark:text-gray-200">7 signups</p>
                            <p class="text-xs leading-5 text-gray-500 dark:text-gray-200">8 outstanding tasks</p>
                        </td>
                    </tr>
                @endforeach
